...
public class DefaultBeanFilter implements BeanFilter
{
    ...
    {
        this.exposeDeltaSpikeBeans = !Boolean.parseBoolean(ConfigResolver.getPropertyValue("exposeDeltaSpikeBeansToSpring", "false"));
    ...
    {
        return exposeDeltaSpikeBeans &&
                !beanClass.getName().startsWith("org.apache.deltaspike.") &&
                !beanClass.getName().startsWith("org.os890.ds.addon.spring.");
    }
