...
/*
    <context-param>
        ...
        <param-value>org.os890.ds.addon.spring.impl.CdiAwareApplicationContextInitializer</param-value>
    </context-param>
 */
public class CdiAwareApplicationContextInitializer implements ApplicationContextInitializer
{
    ...
    public void initialize(ConfigurableApplicationContext applicationContext)
    {
        applicationContext.addBeanFactoryPostProcessor(
            new CdiAwareBeanFactoryPostProcessor(SpringBridgeExtension.getCdiBeans()));
    }
}
