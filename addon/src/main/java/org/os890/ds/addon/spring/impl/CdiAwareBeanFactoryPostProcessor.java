...
{
    private List<Bean<?>> cdiBeansForSpringRegistration = new ArrayList<Bean<?>>();

    public CdiAwareBeanFactoryPostProcessor(List<Bean<?>> cdiBeansForSpringRegistration)
    {
        this.cdiBeansForSpringRegistration = cdiBeansForSpringRegistration;
    }
    ...
    public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException
    {
        ...
        try
        {
            for (Bean<?> bean : this.cdiBeansForSpringRegistration)
            {
            ...
            beanFactory.registerScope(CdiSpringScope.class.getName(), new CdiSpringScope());
        }
        catch (Exception e)
        {
