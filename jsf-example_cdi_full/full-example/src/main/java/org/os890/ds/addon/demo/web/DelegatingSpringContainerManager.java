...
import org.os890.ds.addon.spring.impl.CdiAwareApplicationContextInitializer;
...
@Exclude
public class DelegatingSpringContainerManager implements SpringContainerManager, ServletContextListener
{
    ...
    public DelegatingSpringContainerManager()
    {
