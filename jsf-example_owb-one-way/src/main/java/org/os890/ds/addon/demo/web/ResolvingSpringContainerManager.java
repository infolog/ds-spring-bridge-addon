...
@Exclude
public class ResolvingSpringContainerManager implements SpringContainerManager
{
    ...
    {
        return (ConfigurableApplicationContext)ContextLoader.getCurrentWebApplicationContext();
    }

    @Override
    public ConfigurableApplicationContext bootContainer(BeanFactoryPostProcessor... beanFactoryPostProcessors)
    {
        throw new UnsupportedOperationException("not supported/needed in one-way mode");
    }
}
