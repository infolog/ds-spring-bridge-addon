...
public class EmptySpringContainerManager implements SpringContainerManager
{
    ...
    {
        foundCdiBeans = new ArrayList<Bean<?>>(SpringBridgeExtension.getCdiBeans());
    ...
    static List<Bean<?>> getFoundCdiBeans()
    {
